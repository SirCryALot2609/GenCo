...
namespace GenCo.Application.Profiles
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Project, ProjectSummaryResponseDto>().ReverseMap();
