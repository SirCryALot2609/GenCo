...
using GenCo.Application.Features.EntityConstraints.Commands.UpdateEntityConstraint;
using GenCo.Domain.Enum;

namespace GenCo.Application.Validators.EntityConstraint;

public class UpdateEntityConstraintCommandValidator 
    : AbstractValidator<UpdateEntityConstraintCommand>
{
    public UpdateEntityConstraintCommandValidator()
    {
