...
using GenCo.Application.Features.Relations.Commands.CreateRelation;
...
public class CreateRelationCommandValidator : AbstractValidator<CreateRelationCommand>
{
    ...
    public CreateRelationCommandValidator(IGenericRepository<Domain.Entities.Relation> repository)
    {
    ...
    private async Task<bool> BeUniqueName(CreateRelationCommand command, string? name, CancellationToken cancellationToken)
    {
